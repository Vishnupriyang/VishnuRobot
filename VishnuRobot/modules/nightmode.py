...
from VishnuRobot import BOT_NAME
from VishnuRobot import telethn as tbot
from VishnuRobot.events import register
from VishnuRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
