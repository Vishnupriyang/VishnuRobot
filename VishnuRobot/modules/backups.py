...
# from VishnuRobot.modules.sql import warns_sql as warnssql
import VishnuRobot.modules.sql.blacklist_sql as blacklistsql

# from VishnuRobot.modules.sql import cust_filters_sql as filtersql
# import VishnuRobot.modules.sql.welcome_sql as welcsql
import VishnuRobot.modules.sql.locks_sql as locksql
import VishnuRobot.modules.sql.notes_sql as sql

# from VishnuRobot.modules.rules import get_rules
import VishnuRobot.modules.sql.rules_sql as rulessql
from VishnuRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from VishnuRobot.__main__ import DATA_IMPORT
from VishnuRobot.modules.connection import connected
from VishnuRobot.modules.helper_funcs.alternate import typing_action
from VishnuRobot.modules.helper_funcs.chat_status import user_admin
from VishnuRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("VishnuRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("VishnuRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `VishnuRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("VishnuRobot{}.backup".format(chat_id))  # Cleaning file
