...
import VishnuRobot.modules.sql.global_bans_sql as gban_sql
import VishnuRobot.modules.sql.users_sql as user_sql
from VishnuRobot import DEV_USERS, OWNER_ID, dispatcher
